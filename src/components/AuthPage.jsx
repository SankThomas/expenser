    ...
    <div className="min-h-screen bg-neutral-950 flex">
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-neutral-900 to-neutral-800 p-12 flex-col justify-center">
        <div className="max-w-lg">
          <div className="flex items-center mb-8">
            <DollarSign className="size-8 text-white mr-3 lg:size-12" />
      ...
      <div className="w-full flex-1 flex flex-col justify-center">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="bg-neutral-800 rounded-xl border border-neutral-700 py-8 pl-6">
            <div className="flex rounded-lg bg-neutral-900 p-1 mb-8 mr-6">
              <button
